...
def _set_parser(parser):
    ...
    uge.add_argument("-b", nargs=1, action=singlearg, metavar="y[es]|n[o]")
    ...
    uge.add_argument("-clear", action="store_true")
    ...
    uge.add_argument("-cwd", action="store_true")
    ...
    uge.add_argument("-h", action="store_true")
    uge.add_argument("-help", action="store_true")
    ...
    uge.add_argument("-j", nargs=1, action=singlearg, metavar="y[es]|n[o]")
    ...
    uge.add_argument("-notify", action="store_true")
    uge.add_argument("-now", nargs=1, action=singlearg, metavar="y[es]|n[o]")
    ...
    uge.add_argument("-pty", nargs=1, action=singlearg, metavar="y[es]|n[o]")
    uge.add_argument("-q", nargs=1, action=appendresource, metavar="qc_queue_list")
    uge.add_argument("-R", nargs=1, action=singlearg, metavar="y[es]|n[o]")
    uge.add_argument("-r", nargs=1, action=singlearg, metavar="y[es]|n[o]")
    uge.add_argument("-row", nargs=1, action=appendkv, metavar="variable,...")
    uge.add_argument("-rdi", nargs=1, action=singlearg, metavar="y[es]|n[o]")
    uge.add_argument("-sc", nargs=1, action=appendkv, metavar="variable[=value],...")
    uge.add_argument("-shell", nargs=1, action=singlearg, metavar="y[es]|n[o]")
    ...
    uge.add_argument("-tcon", nargs=1, action=singlearg, metavar="y[es]|n[o]")
    uge.add_argument("-terse", action="store_true")
    ...
    uge.add_argument("-verify", action="store_true")
    uge.add_argument("-V", action="store_true")
    ...
    uge.add_argument("-xd_run_as_image_user", nargs=1, action=singlearg, metavar="y[es]|n[o]")
